...
from neurinferno.model.encoder import PAD_IDX, ByteEncoder
from neurinferno.model.heads import (
    BIOTaggingHead,
    BoundaryHead,
    FieldTypeHead,
    RelationalFieldTypeHead,
)
...
class FullModel(nn.Module):
    ...
    def __init__(
        ...
        if use_bio_head:
            ...
            self.boundary_head = BoundaryHead(d_model=d_model, disable_entropy=disable_entropy)
